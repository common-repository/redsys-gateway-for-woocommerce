...
class WC_Redsys_Gateway extends WC_Payment_Gateway {
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
				...
				'paymentType' => array(
						'title'       => __( 'Payment types allowed', 'redsys_gw_woo' ),
						'type'        => 'select',
						'description' => __( 'You can choose between iupay and credit cards or only credit cards.', 'redsys_gw_woo' ),
						'default'     => 'T',
						'desc_tip'    => true,
						'options'     => array(
							'C' => __( 'Only credit cards', 'redsys_gw_woo' ),
							'T' => __( 'Credit cards and iupay', 'redsys_gw_woo' )
						)
				),
				'after_payment' => array(
	...
	function prepare_args( $order ) {
		...
		$args = array (
				...
				'Ds_Merchant_PayMethods' 			=> $this->paymentType,
